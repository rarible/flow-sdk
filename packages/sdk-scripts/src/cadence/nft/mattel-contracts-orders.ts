...
// import ${HWGaragePack.name} from ${HWGaragePack.testnetAddressRaribleDeployed}
//         let ${HWGaragePack.name}ProviderPrivatePath = ${HWGaragePack.privatePath}
//%nftStoragePath%
...
transaction(listingResourceID: UInt64, storefrontAddress: Address, commissionRecipient: Address?) {
    ...
    let %nftContract%Collection: &%nftContract%.Collection{NonFungibleToken.Receiver}
    ...
    prepare(acct: AuthAccount) {
        ...
        self.%nftContract%Collection = acct.borrow<&%nftContract%.Collection{NonFungibleToken.Receiver}>(
