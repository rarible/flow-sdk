...
describe("collection", () => {
	...
	test("isFlowCollectionId: must validate collection address with id", () => {
	...
	test("isFlowCollectionId: must validate invalid collection id", () => {
	...
	test("isFlowCollectionId: must validate invalid collection", () => {
