...
export const flowCollectionsConfig: Record<NonFungibleContract, FlowConfigData> = {
	...
	HWGarageTokenV2: {
		contractsNames: ["HWGarageTokenV2"] as FlowContractAddressName[],
		features: ["TRANSFER", "BURN"],
	},
	BBxBarbiePack: {
...
export const CONFIGS: Record<FlowNetwork, Config> = {
	...
	testnet: {
		...
		mainAddressMap: {
			...
			HWGaragePack: toFlowAddress("6f6702697b205c18"),
			HWGarageCard: toFlowAddress("0x6f6702697b205c18"),
			HWGaragePackV2: toFlowAddress("0x6f6702697b205c18"),
			HWGarageCardV2: toFlowAddress("0x6f6702697b205c18"),
			HWGarageTokenV2: toFlowAddress("0x6f6702697b205c18"),
